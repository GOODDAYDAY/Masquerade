...
3. **第一晚强烈建议使用解药**——保住一个好人比留解药到后面更有价值。第一晚信息少，留解药后面反而可能因为犹豫而浪费。
4. 如果解药已用，跳过此项。
...
3. **已暴露身份优先：**
   ...
   - 如果有人暴露了女巫/猎人身份，优先保护
   - 暴露身份的人被刀概率远高于普通玩家
4. **自守时机：** 如果你在白天发言中暴露了守卫身份，或者被多人怀疑，考虑守自己。守卫活着才能继续保护。
5. **保护优先级：** 已确认身份的好人神职 > 暴露身份的角色 > 发言有逻辑的疑似好人 > 随机
